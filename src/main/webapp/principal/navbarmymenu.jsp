                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="<%=request.getContextPath()%>/<%=request.getContextPath()%>/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                              ...
                              <div class="main-menu-content">
                                  <ul>
                                      <li class="more-details">
                                          ...
                                          <a href="<%=request.getContextPath() %>/ServletsLogin?acao=Logout"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
