...
<body>
												...
												<div class="card">
													...
													<div class="card-block">
														...
														<form class="form-material"
															...
															<button class="btn btn-success waves-effect waves-light">Salvar</button><!-- SUBMIT -->
															<button type="button" class="btn btn-info waves-effect waves-light"    onclick="criaDeleteAjax();">Excluir</button>
	...
	<div class="modal fade" id="exampleModalUsuario" tabindex="-1"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div style="height: 300px; overflow: scroll;"> <!-- scroll na tela -->
				...
				<span id="resultadoEncontrado"></span>
	...
	function editarUsuario(id){
		//redirecionar para servlets
		var urlAction = document.getElementById("formUser").action;
		
		//redirecionamento com javascript, passar os parametros para url
	...
	function buscarUsuario(){
		...
		if(nomeBusca != null && nomeBusca != '' && nomeBusca.trim() !=''){/*verificar se ha valor para busca*/
			...
			$.ajax({
				...
				//PASSAR A STRING PAA JASON E MOSTRAR NA TELA	
				var json= JSON.parse(response)
				
				//alert(jason);
				//console.info;   +ctrl+shift+j (o navegador imprime os dados do console)
				...
				for(var p = 0; p < json.length; p++){
					$('#tabelaUsuario > tbody').append('<tr><td>'+json[p].id+'</td><td>'+json[p].nome+'</td><td><button type="button" onclick="editarUsuario('+json[p].id+');" class="btn btn-info">ver</button></td></tr>')
				}
				
				
				document.getElementById('resultadoEncontrado').textContent='Resultados: ' + json.length;
		...
		function limparForm() {
			...
			var elementos = document.getElementById("formUser").elements; /*retorna os elemneto do formulario*/
